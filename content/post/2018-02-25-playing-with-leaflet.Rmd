...
tags:
  - leaflet
  - mapping
summary: "I ran across a package called ```mapsapi``` a while back, and it has some nice functionality for pulling Google Maps information. In poking around, I didn't see any ability to get directions either to or from multiple locations. So I took a portion of the code from that package and rewrote it to do so."
---
