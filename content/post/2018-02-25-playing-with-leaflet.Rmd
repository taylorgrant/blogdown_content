...
I just ran across a new package called ```mapsapi``` which has some nice functionality for pulling Google Maps information. In poking around, I didn't see any ability to get directions either to or from multiple locations. So I took a portion of the code from that package and rewrote it to do so. Is there much reason to do this? No, probably not, but it's fun.  
