...
Now that I have the latitiudes and longitudes of each city that I travelled from and to, I can think about mapping the last eight years of trips. But when looking at my trips - 5 of these 8 years I was in grad school - it's apparent that while I travelled a bit, I didn't travel that far afield. This means that using a full world map doesn't make the most sense. 
