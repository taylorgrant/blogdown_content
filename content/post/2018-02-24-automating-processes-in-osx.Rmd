...
Note that it's a good idea to see if the bash file will run on its own in terminal. Give yourself permission to do so with the command `chmod +x /path/to/bashScript.sh.
