...
categories: ["R"]
tags: ["data ingest", "mapping", "broom"]
---
...
```{r, cache = TRUE, map, warning = FALSE, message = FALSE}
...
When all else fails, it is also possible to scrape data using the ```rvest``` package. Here, we'll scrape the [Fangraphs](https://www.fangraphs.com/) website for the 2017 offensive players leaderboard. 
