...
tags:
  - rvest
  - scraping
summary: "I've always used the `rvest` package in tandem with the SelectorGadget to select the CSS of a table on a website, but it turns out that there is a much simpler way of extracting data tables from the web."
---
